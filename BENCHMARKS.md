...
| Metric | Value |
|---|---|
| lint job duration | pending GitHub Actions run |
| test job duration | pending GitHub Actions run |
| image-smoke — cold run | pending GitHub Actions run |
| image-smoke — warm run (GHA cache) | pending GitHub Actions run |
| bad-pr blocked by branch protection? | pending GitHub branch-protection demo |
